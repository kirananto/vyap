...
export default function OrderCard({ className, thread }: { className: string, thread: any }) {
  ...
  return (
    <div className={`flex ${className} w-full`}>
      <NavLink to={`/order/${thread.meta}`} className="flex flex-col w-10/12 max-w-md gap-1 p-4 bg-white rounded-lg hover:bg-gray-50 shadow border border-purple-900 border-opacity-50 dark:bg-gray-800 dark:hover:bg-gray-600">
