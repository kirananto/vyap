    ...
    return (
        <div className="p-4">
            <div className="flex justify-end">
                ...
                >
                    <div className="bg-white rounded-full w-min p-2 text-slate-600 dark:text-slate-400 dark:bg-transparent">
            ...
            <div className="p-4 border border-slate-300 rounded mt-2 dark:border-slate-500">
                <div>
                    ...
                    <div className="text-slate-400 text-sm dark:text-slate-400">
                        12312312312312
                    </div>
                </div>
                ...
                {a.map((item, index) => (
                    <div key={`${index}`}>
                        <div className={`flex justify-between pb-2 ${index === a.length - 1 ? 'border-b-2 border-dashed border-grey-300 mb-2 pb-2 dark:border-slate-500' : ''}`}>
                            ...
                            <div className="flex text-slate-400 dark:text-slate-300 text-xs font-extrabold">
                                ₹1500
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex justify-end">
                    <div>
                        <div className="flex text-slate-400 text-xs font-extrabold justify-center">
                            Total
                        </div>
                        <div className="text-slate-600 text-lg font-extrabold justify-center dark:text-slate-300">
                            ₹ 5000
                        </div>
                    </div>
                </div>
