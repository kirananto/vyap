    ...
    return (
        <div className="p-4">
            <div className="flex justify-end">
                <div 
                    className="flex w-max border border-gray-300 rounded items-center pr-2 cursor-pointer"
                    onClick={() => history.push(`/purchase-order/${id}`)}
                >
                    <div className="bg-white rounded-full w-min p-2 text-gray-600">
            ...
            <div className="p-4 border border-gray-300 rounded mt-2">
                ...
                <div className="text-gray-600 text-sm pt-2 mt-2 border-t-2 border-dashed border-grey-300">
                    Items list
                </div>
                {a.map((item, index) => (
                    <div key={`${index}`}>
                        <div className={`flex justify-between pb-2 ${index === a.length - 1 ? 'border-b-2 border-dashed border-grey-300 mb-2 pb-2' : ''}`}>
