    ...
    return (
        <div className="bg-white rounded-lg p-4 mt-4 w-full dark:bg-gray-700">
            <div className="flex w-full items-center justify-between">
                <div className="flex text-xl dark:text-gray-300">
                    Items
                </div>
                <div className="flex">
                    {isExpanded ? (<div className="flex text-gray-600 dark:text-gray-300" onClick={() => setIsExpanded(false)}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 15l7-7 7 7" />
                        </svg>
                    </div>

                    ) : (<div className="flex text-gray-600 dark:text-gray-300" onClick={() => setIsExpanded(true)}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {isExpanded && <div>
                ...
                {items.map((item, index) => (<div className="flex justify-between" key={`${index}`}>
                    ...
                    <div className="flex pt-4 gap-2">
                        ...
                        <div className="flex items-center dark:text-gray-200">10</div>
                        <div className="flex text-blue-600 dark:text-blue-400 items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 cursor-pointer" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex text-lg font-bold text-gray-600 dark:text-gray-200 items-center">
                        ₹500
                    </div>
                </div>))}
                <div className="flex w-full border border-dashed dark:border-gray-500 py-2 mt-4 cursor-pointer justify-center">
                    <div className="flex">
