...
export default function Success({
    ...
    return (
        <div>
            ...
            <button onClick={successAction} className="save-btn p-3 w-48 text-indigo-700 rounded-full border border-indigo-700  dark:border-indigo-200 dark:text-indigo-200">
        Close
            </button>
        </div>)
}