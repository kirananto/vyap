    ...
    return (
        <div className="px-4">
            <div className={'flex my-2 gap-4'}>
                ...
                <div onClick={onFilterClick} className={'flex border border-gray-200 rounded place-items-center px-4 py-1 text-slate-400 cursor-pointer text-base font-semibold'}>
