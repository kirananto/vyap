...
export default function OrderStatusIcon({ status }: { status: OrderStatusEnum }) {
    switch (status) {
        ...
        case OrderStatusEnum.PROCESSING: return (<span className='text-blue-800'><Processing /></span>)
        case OrderStatusEnum.PENDING: return (<span className='text-yellow-400'><Pending /></span>)
