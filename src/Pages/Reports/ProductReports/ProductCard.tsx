    ...
    return (       
        ...
        >
            <div className="flex py-4 basis-10/12 pl-2 ">
                ...
                <div className="basis-3/12 w-15 h-full text-center border border-slate-200 dark:border-slate-600 relative aspect-square rounded-lg overflow-hidden bg-cover bg-center empty_image_background">
                    {item?.productImage && (
                        <img
                            loading="lazy"
                            src={getImageURL(
