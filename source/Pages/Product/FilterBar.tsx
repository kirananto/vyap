  ...
  return (
    <>
      ...
      <div className="relative flex justify-between w-11/12 gap-2 mx-auto mt-2 ">
        ...
        {/* ===Button-2=== */}
        <button className="inline-flex items-center justify-center w-2/4 px-2 py-1 font-bold text-gray-500 bg-gray-300 rounded ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5"
            fill="none"
        ...
        {/* ===Button-3=== */}
        <button onClick={onMoreClick} className="inline-flex items-center justify-center w-1/4 px-2 py-1 font-bold text-gray-500 bg-gray-300 rounded ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-5 h-5"
            fill="none"
